...
1. [Fork](https://github.com/jboss-integration/bxms-boms/fork) the project. This creates a the project in your own Git.

2. Clone your fork. This creates a directory in your local file system.

        git clone git@github.com:<your-username>/bxms-boms.git

3. Add the remote `upstream` repository.

        git remote add upstream git@github.com:jboss-integration/bxms-boms.git
